...
data.drop(['budget', 'homepage', 'original_language','id','movie_id','release_date','popularity','tagline','production_countries','production_companies','runtime','original_title','status','vote_average','vote_count','revenue','spoken_languages'], axis=1, inplace=True)
...
tv = TfidfVectorizer()
count_matrix = tv.fit_transform(data['soup'])
...
movies_user_likes = ["The Dark Knight Rises",  "Skyfall","Avatar", "Spider-Man 2", "X-Men: The Last Stand"]
